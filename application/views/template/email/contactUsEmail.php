                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody" style="background-color: #ffffff;border-top: 5px solid #000000;padding-right: 20px;padding-left: 20px;border-bottom: 5px solid #000000;">
                  <tbody><tr>
                    <td align="left" valign="top" style="line-height: 150%;font-family: Helvetica;font-size: 14px;color: #8f8f8f;padding: 20px;">
                      ...
                      <table border="0" cellpadding="20" cellspacing="0" width="90%" style="margin: 0 auto;">
                          <tbody>
                              <tr style="line-height: 150%; font-family: Helvetica;font-size: 16px; color: #000000;">
                                  <td align="left" width="20%" valign="top" style="font-weight: 700;padding: 3px 0;">Name</td>
                                  <td align="center" width="10" valign="top" style="padding: 3px 0;"> &nbsp;:&nbsp; </td>
                                  <td align="left" width="80%" valign="top" style="padding: 3px 0;">
                                      <?php echo $name; ?>
                                  </td>
                              </tr>
                              <tr style="line-height: 150%; font-family: Helvetica;font-size: 16px; color: #000000;">
                                  <td align="left" width="20%" valign="top" style="font-weight: 700;padding: 3px 0;">Email</td>
                                  <td align="center" width="10" valign="top" style="padding: 3px 0;"> &nbsp;:&nbsp; </td>
                                  <td align="left" width="80%" valign="top" style="padding: 3px 0;">
                                      <?php echo $email; ?>
                                  </td>
                              </tr>
                              <tr style="line-height: 150%; font-family: Helvetica;font-size: 14px; color: #000000;">
                                  <td align="left" width="20%" valign="top" style="font-weight: 700;padding: 3px 0;">Description</td>
                                  <td align="center" width="10" valign="top" style="padding: 3px 0;"> &nbsp;:&nbsp; </td>
                                  <td align="left" width="80%" valign="top" style="padding: 3px 0;">
