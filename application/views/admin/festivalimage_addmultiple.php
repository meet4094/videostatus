                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo BASE_URL . 'admin/festivalimage/add_multiimage'; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-2 col-md-10">
                                                    <button class="btn elegant" type="submit" name="submit" id="">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                </form>
