...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "businesscategory", "SubMenu" => "businesscategory_edit"); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Edit Business Category
                        <small>form</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light bordered">
                                ...
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to edit Business Category. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Business Category has been edited. 
                                    </div>
                                <?php } ?>
                                    <?php
                                    if (isset($edit_businesscategory['image']) && $edit_businesscategory['image'] != "")
                                        $edit_businesscategory['image'] = '<a target="_blank" href="'.BUSINESSCATEGORY_IMAGE_URL.DS.$edit_businesscategory['image'].'"><img width="150" src="'.BUSINESSCATEGORY_IMAGE_URL.DS.$edit_businesscategory['image'].'"/></a>';
                                    ?>
                                    <form action="<?php echo BASE_URL."admin/businesscategory/edit/".$edit_businesscategory['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="alert alert-danger display-hide">
                                            <button class="close" data-close="alert"></button> You have some form errors. Please check below. 
                                        </div>
                                        <input type="hidden" value="<?php echo $edit_businesscategory['id']; ?>" name="id">
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label">Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="<?php echo $edit_businesscategory['name']; ?>" name="name" class="form-control" placeholder="Enter businesscategory name">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-3">
                                                    <?php echo $edit_businesscategory['image']; ?>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="md-radio-inline">
                                                        <div class="md-radio has-error">
                                                            <input value="0" type="radio" id="radio55" name="detail_display" <?php if($edit_businesscategory['detail_display'] == 0){ echo 'checked="checked"'; } ?> class="md-radiobtn">
                                                            <label for="radio55">
                                                                <span></span>
                                                        ...
                                                        <div class="md-radio">
                                                            <input value="1" type="radio" id="radio56" name="detail_display" <?php if($edit_businesscategory['detail_display'] == 1){ echo 'checked="checked"'; } ?> class="md-radiobtn">
                                                            <label for="radio56">
                                                                <span></span>
                                                                <span class="check"></span>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="detail_message" class="form-control" placeholder="Enter detail message.." <?php echo $edit_businesscategory['detail_message']; ?>>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="md-radio-inline">
                                                        <div class="md-radio">
                                                            <input value="0" type="radio" id="radio53" name="is_del" <?php if($edit_businesscategory['is_del'] == 0){ echo 'checked="checked"'; } ?>  class="md-radiobtn">
                                                            <label for="radio53">
                                                                <span></span>
                                                                <span class="check"></span>
                                                        ...
                                                        <div class="md-radio has-error">
                                                            <input value="1" type="radio" id="radio54" name="is_del" <?php if($edit_businesscategory['is_del'] == 1){ echo 'checked="checked"'; } ?> class="md-radiobtn">
                                                            <label for="radio54">
                                                                <span></span>
                                                                <span class="check"></span>
