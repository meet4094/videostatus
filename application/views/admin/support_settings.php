...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "support_settings", "SubMenu" => ""); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Support Setting
                        <small>form</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <?php } ?>
                                    <form action="<?php echo BASE_URL."admin/settings/support_settings" ;?>" role="form" method="post" class="form-horizontal">
                                        <div class="alert alert-danger display-hide">
                                            <button class="close" data-close="alert"></button> You have some form errors. Please check below. 
                                        </div>
                                        <div class="form-body">
                                            <h3 class="form-section">Contact Email</h3>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label">Support Email</label>
                                                <div class="col-md-10">
                                                    <div class="input-icon">
                                                        <input  value="<?php echo $iSettings['support_email']; ?>" name="support_email" type="email" class="form-control" placeholder="Support Email">
                                                        <span class="help-block"> All contact mail will send to this email. </span>
                                                        <div class="form-control-focus"> </div>
                                                        <i class="fa fa-envelope-o"></i>
                                                    </div>
                                                </div>
                                            </div>
                                            <h3 class="form-section">Support Links</h3>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label">Privacy Policy URL</label>
                                                <div class="col-md-10">
                                                    <div class="input-icon">
                                                        <input  value="<?php echo $iSettings['privacy_policy_url']; ?>" name="privacy_policy_url" type="url" class="form-control" placeholder="Privacy Policy URL">
                                                        <div class="form-control-focus"> </div>
                                                        <i class="fa fa-envelope-o"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label">Share App Link</label>
                                                <div class="col-md-10">
                                                    <div class="input-icon">
                                                        <input  value="<?php echo $iSettings['share_app_link']; ?>" name="share_app_link" type="url" class="form-control" placeholder="Share App Link">
                                                        <div class="form-control-focus"> </div>
                                                        <i class="fa fa-envelope-o"></i>
                                                    </div>
                                                </div>
