...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "user", "SubMenu" => "user_view"); ?>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="userList">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="3%"> Is Active Profile? </th>
                                                    <th width="3%"> Email Confirm? </th>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter" name="email"> 
                                                    </td>
                                                    <td> </td>
                                                    <td> 
                                                        <select name="is_active_profile" class="form-control form-filter">
                                                    ...
                                                    <td> 
                                                        <select name="is_active" class="form-control form-filter">
                                                            <option value="">Select...</option>
                ...
                var handleRecords = function () {
                    ...
                    grid.init({
                        ...
                        dataTable: { 
                            ...
                            "responsive" : true,
                            "ajax": {
                                "url": "<?php echo BASE_URL; ?>admin/user/users_list", // ajax source
                            }
                        }
                    });
                }
