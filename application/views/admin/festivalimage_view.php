...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        <?php $iData['SelectedMenu'] = array("MainMenu" => "festivalimage", "SubMenu" => "festivalimage_view"); ?>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Festival Image
                    <small>listing</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    <div class="table-actions-wrapper">
                                        <!-- <a href="<?php //echo BASE_URL . "admin/festivalimage/add"; 
                                                        ?>" class="btn btn-sm elegant">
                                            <i class="fa fa-plus"></i>
                                            <span class="title">Add Festival Image</span>
                                        </a>
                                        <a href="<?php //echo BASE_URL . "admin/festivalimage/add_multiimage"; 
                                                    ?>" class="btn btn-sm elegant">
                                            <i class="fa fa-plus"></i>
                                            <span class="title">Add Multiple Festival Image</span>
                                        </a> -->
                                        <a href="<?php echo BASE_URL . "admin/festivalimage/add_fileupload"; ?>" class="btn btn-sm elegant">
                                            <i class="fa fa-plus"></i>
                                            <span class="title">Add Multiple Festival Image</span>
                                        </a>
                                        <a href="<?php echo BASE_URL . "admin/festivalimage/add_dropzonimage"; ?>" class="btn btn-sm elegant">
                                            <i class="fa fa-plus"></i>
                                            <span class="title">Add Festival Dropzon</span>
                                        </a>
                                    </div>
                                    <table class="table table-striped table-bordered table-hover table-checkable" id="festivalimageList">
                                        <thead>
                                                ...
                                                <td>
                                                    <select name="category_id" class="form-control form-filter">
                                                        ...
                                                        <?php foreach ($festivalcategories as $key => $festivalcategory) { ?>
                                                            <option value="<?php echo $festivalcategory['id']; ?>" name="category_id"><?php echo $festivalcategory['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </td>
                                                <td> </td>
            ...
            var handleRecords = function() {
                ...
                grid.init({
                    ...
                    dataTable: {
                        ...
                        "responsive": true,
                        "ajax": {
                            "url": "<?php echo BASE_URL; ?>admin/festivalimage/load_festivalimage", // ajax source
                        }
                    }
                });
            }
