...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "festivalcategory", "SubMenu" => "festivalcategory_add"); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Add Festival Category
                        <small>form</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light bordered">
                                ...
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to add Festival Category. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Festival Category has been added. 
                                    </div>
                                <?php } ?>
                                    <form action="<?php echo BASE_URL."admin/festivalcategory/add" ;?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control date-picker" name="festival_date" placeholder="Enter date.." data-date-format="yyyy-mm-dd">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control date-picker" name="active_from" placeholder="Enter date.." data-date-format="yyyy-mm-dd">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="md-radio-inline">
                                                        <div class="md-radio has-error">
                                                            <input value="0" type="radio" id="radio55" name="detail_display" checked="checked" class="md-radiobtn">
                                                            <label for="radio55">
                                                                <span></span>
                                                        ...
                                                        <div class="md-radio">
                                                            <input value="1" type="radio" id="radio56" name="detail_display" class="md-radiobtn">
                                                            <label for="radio56">
                                                                <span></span>
                                                                <span class="check"></span>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="detail_message" class="form-control" placeholder="Enter detail message..">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
