...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        <!-- <?php $iData['SelectedMenu'] = array("MainMenu" => "category", "SubMenu" => "category_view"); ?> -->
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    <div class="table-actions-wrapper">
                                        <a href="<?php echo BASE_URL . "admin/category/add"; ?>" class="btn btn-sm elegant">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable" id="festivalcategoryList">
                                        <thead>
                                            <tr role="row" class="heading">
                                                ...
                                                <th style="padding-left: 15px;">Festivel date</th>
                                                <th style="padding-left: 15px;">Active from</th>
                                                <th style="padding-left: 15px;">Detail Message</th>
                ...
                var handleRecords = function() {
                    ...
                    grid.init({
                        ...
                        dataTable: {
                            ...
                            "responsive": true,
                            "ajax": {
                                "url": "<?php echo BASE_URL; ?>admin/category/load_festivalcategory", // ajax source
                            }
                        }
                    });
                }
