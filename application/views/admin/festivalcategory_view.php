...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "festivalcategory", "SubMenu" => "festivalcategory_view"); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Festival Category
                        <small>listing</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            <a href="<?php echo BASE_URL . "admin/festivalcategory/add"; ?>" class="btn btn-sm elegant">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">Add Festival Category</span>
                                            </a>
                                        </div>
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="festivalcategoryList">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    <th width="2%"> # </th>
                                                    <th width="5%"> Name </th>
                                                    <th width="5%"> Festival Date </th>
                                                    <th width="5%"> Activation Date </th>
                                                    <th width="8%"> Image </th>
                                                    <th width="8%"> Is Detail Display? </th>
                                                    <th width="8%"> Detail Message </th>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td> </td>
                                                    <td> 
                                                        <select name="detail_display" class="form-control form-filter">
                ...
                var handleRecords = function () {
                    ...
                    grid.init({
                        ...
                        dataTable: { 
                            ...
                            "responsive": true,
                            "ajax": {
                                "url": "<?php echo BASE_URL; ?>admin/festivalcategory/load_festivalcategory", // ajax source
                            }
                        }
                    });
                }
