...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        <?php $iData['SelectedMenu'] = array("MainMenu" => "slider", "SubMenu" => "slider_edit"); ?>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Edit Slider
                    <small>form</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to edit slider. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A slider has been edited.
                                    </div>
                                <?php } ?>
                                <?php
                                if (isset($edit_slider['image']) && $edit_slider['image'] != "")
                                    $edit_slider['image'] = '<a target="_blank" href="' . SLIDER_IMAGE_URL . DS . $edit_slider['image'] . '"><img width="150" src="' . SLIDER_IMAGE_URL . DS . $edit_slider['image'] . '"/></a>';
                                ?>
                                <form action="<?php echo BASE_URL . "admin/slider/edit/" . $edit_slider['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="alert alert-danger display-hide">
                                        <button class="close" data-close="alert"></button> You have some form errors. Please check below.
                                    </div>
                                    <input type="hidden" value="<?php echo $edit_slider['id']; ?>" name="id">
                                    <div class="form-body">
                                        <div class="form-group form-md-line-input">
                                            <label class="col-md-2 control-label">Name</label>
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo $edit_slider['name']; ?>" name="name" class="form-control" placeholder="Enter slider name">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="url" value="<?php echo $edit_slider['link']; ?>" name="link" class="form-control" placeholder="Enter link">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="type_id">
                                                    ...
                                                    <?php foreach ($types as $key => $type) { ?>
                                                        <option <?php if($edit_slider['type_id'] == $type['id']) { echo 'selected'; } ?> value="<?php echo $type['id']; ?>"><?php echo $type['name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input value="0" type="radio" id="radio53" name="is_del" <?php if ($edit_slider['is_del'] == 0) {
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="1" type="radio" id="radio54" name="is_del" <?php if ($edit_slider['is_del'] == 1) {
                                                                                                                        echo 'checked="checked"';
                                                                                                                    } ?> class="md-radiobtn">
                                                        <label for="radio54">
                                                            <span></span>
