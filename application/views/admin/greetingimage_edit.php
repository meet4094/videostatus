...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "greetingimage", "SubMenu" => "greetingimage_edit"); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Edit Greeting Image
                        <small>form</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light bordered">
                                ...
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to edit Greeting Image. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Greeting Image has been edited. 
                                    </div>
                                <?php } ?>
                                    <?php
                                    if (isset($edit_greetingimage['image']) && $edit_greetingimage['image'] != "")
                                        $edit_greetingimage['image'] = '<a target="_blank" href="'.GREETINGIMAGE_IMAGE_URL.DS.$edit_greetingimage['image'].'"><img width="150" src="'.GREETINGIMAGE_IMAGE_URL.DS.$edit_greetingimage['image'].'"/></a>';
                                    ?>
                                    <form action="<?php echo BASE_URL."admin/greetingimage/edit/".$edit_greetingimage['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="alert alert-danger display-hide">
                                            <button class="close" data-close="alert"></button> You have some form errors. Please check below. 
                                        </div>
                                        <input type="hidden" value="<?php echo $edit_greetingimage['id']; ?>" name="id">
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label">Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="<?php echo $edit_greetingimage['name']; ?>" name="name" class="form-control" placeholder="Enter greetingimage name">
                                           ...
                                           <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="description" class="form-control" placeholder="Enter description.." value="<?php echo $edit_greetingimage['description']; ?>">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" name="category_id">
                                                        ...
                                                        <?php foreach ($greetingcategories as $key => $greetingcategory) { ?>
                                                            <option <?php if($edit_greetingimage['category_id'] == $greetingcategory['id']) { echo 'selected'; } ?> value="<?php echo $greetingcategory['id']; ?>"><?php echo $greetingcategory['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" name="language_id">
                                                        ...
                                                        <?php foreach ($languages as $key => $language) { ?>
                                                            <option <?php if($edit_greetingimage['language_id'] == $language['id']) { echo 'selected'; } ?> value="<?php echo $language['id']; ?>"><?php echo $language['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-3">
                                                    <?php echo $edit_greetingimage['image']; ?>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="md-radio-inline">
                                                        <div class="md-radio">
                                                            <input value="0" type="radio" id="radio53" name="is_del" <?php if($edit_greetingimage['is_del'] == 0){ echo 'checked="checked"'; } ?>  class="md-radiobtn">
                                                            <label for="radio53">
                                                                <span></span>
                                                        ...
                                                        <div class="md-radio has-error">
                                                            <input value="1" type="radio" id="radio54" name="is_del" <?php if($edit_greetingimage['is_del'] == 1){ echo 'checked="checked"'; } ?> class="md-radiobtn">
                                                            <label for="radio54">
                                                                <span></span>
                                                                <span class="check"></span>
