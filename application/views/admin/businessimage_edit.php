...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "businessimage", "SubMenu" => "businessimage_edit"); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Edit Business Image
                        <small>form</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light bordered">
                                ...
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to edit Business Image. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Business Image has been edited. 
                                    </div>
                                <?php } ?>
                                    <?php
                                    if (isset($edit_businessimage['image']) && $edit_businessimage['image'] != "")
                                        $edit_businessimage['image'] = '<a target="_blank" href="'.BUSINESSIMAGE_IMAGE_URL.DS.$edit_businessimage['image'].'"><img width="150" src="'.BUSINESSIMAGE_IMAGE_URL.DS.$edit_businessimage['image'].'"/></a>';
                                    ?>
                                    <form action="<?php echo BASE_URL."admin/businessimage/edit/".$edit_businessimage['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="alert alert-danger display-hide">
                                            <button class="close" data-close="alert"></button> You have some form errors. Please check below. 
                                        </div>
                                        <input type="hidden" value="<?php echo $edit_businessimage['id']; ?>" name="id">
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label">Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="<?php echo $edit_businessimage['name']; ?>" name="name" class="form-control" placeholder="Enter businessimage name">
                                           ...
                                           <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="description" class="form-control" placeholder="Enter description.." value="<?php echo $edit_businessimage['description']; ?>">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" name="category_id">
                                                        ...
                                                        <?php foreach ($businesscategories as $key => $businesscategory) { ?>
                                                            <option <?php if($edit_businessimage['category_id'] == $businesscategory['id']) { echo 'selected'; } ?> value="<?php echo $businesscategory['id']; ?>"><?php echo $businesscategory['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" name="language_id">
                                                        ...
                                                        <?php foreach ($languages as $key => $language) { ?>
                                                            <option <?php if($edit_businessimage['language_id'] == $language['id']) { echo 'selected'; } ?> value="<?php echo $language['id']; ?>"><?php echo $language['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-3">
                                                    <?php echo $edit_businessimage['image']; ?>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="md-radio-inline">
                                                        <div class="md-radio">
                                                            <input value="0" type="radio" id="radio53" name="is_del" <?php if($edit_businessimage['is_del'] == 0){ echo 'checked="checked"'; } ?>  class="md-radiobtn">
                                                            <label for="radio53">
                                                                <span></span>
                                                        ...
                                                        <div class="md-radio has-error">
                                                            <input value="1" type="radio" id="radio54" name="is_del" <?php if($edit_businessimage['is_del'] == 1){ echo 'checked="checked"'; } ?> class="md-radiobtn">
                                                            <label for="radio54">
                                                                <span></span>
                                                                <span class="check"></span>
