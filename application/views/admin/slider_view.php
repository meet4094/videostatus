...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        <?php $iData['SelectedMenu'] = array("MainMenu" => "slider", "SubMenu" => "slider_view"); ?>
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    <div class="table-actions-wrapper">
                                        <a href="<?php echo BASE_URL . "admin/slider/add"; ?>" class="btn btn-sm elegant">
                                            <i class="fa fa-plus"></i>
                                            <span class="title">Add Slider</span>
                                        </a>
                                    </div>
                                    <table class="table table-striped table-bordered table-hover table-checkable" id="sliderList">
                                        <thead>
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td> </td>
                                                <td>
                                                    <select name="type_id" class="form-control form-filter">
            ...
            var handleRecords = function() {
                ...
                grid.init({
                    ...
                    dataTable: {
                        ...
                        "responsive": true,
                        "ajax": {
                            "url": "<?php echo BASE_URL; ?>admin/slider/load_slider", // ajax source
                        }
                    }
                });
            }
