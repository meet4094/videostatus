...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "greetingcategory", "SubMenu" => "greetingcategory_view"); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Greeting Category
                        <small>listing</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            <a href="<?php echo BASE_URL . "admin/greetingcategory/add"; ?>" class="btn btn-sm elegant">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">Add Greeting Category</span>
                                            </a>
                                        </div>
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="greetingcategoryList">
                                            <thead>
                ...
                var handleRecords = function () {
                    ...
                    grid.init({
                        ...
                        dataTable: { 
                            ...
                            "responsive": true,
                            "ajax": {
                                "url": "<?php echo BASE_URL; ?>admin/greetingcategory/load_greetingcategory", // ajax source
                            }
                        }
                    });
                }
